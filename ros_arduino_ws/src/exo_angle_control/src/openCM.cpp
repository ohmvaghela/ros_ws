...
void ExoAngleCB(const exo_angle_control::ExoAngle &msg)
{
    hipLeft = msg.hipLeft;
...
int main(int argc, char **argv)
{
    ...
    // publisher
    ros::Publisher angle_pub = n.advertise<exo_angle_control::ExoAngle>("OpenCMTopic", 1000);

    // subscriber
    ros::Subscriber sub = n.subscribe("ArduinoTopic", 1000, ExoAngleCB);
